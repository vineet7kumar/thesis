...
\chapter{Introduction to \xten and contrast with \matlab} \label{chap:Xten}
\input{text/xten}
...
%\input{text/background}
%-Introduction to McLab
%-Introduction to McSAF and Tamer
%-MiX10 as a static backend
...
\chapter{Compiling for high performance of sequential code} \label{chap:Performance}
\input{text/performance}
%-Arrays
%-IntOk Analysis

\chapter{Concurrency constructs in MiX10} \label{chap:Concurrency}
\input{text/concurrency}
%-handling builting concurrency
%-adding new constructs

%\chapter{Framework for handling builtin functions} \label{chap:Builtin}
%\input{text/builtin}
...
\chapter{isComplex value analysis} \label{chap:Analysis}
\input{text/analysis}
%//Add variable rename analysis ?
