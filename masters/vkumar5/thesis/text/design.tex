...
built-in handler in \chapref{chap:Builtins} and code generation strategy for the
sequential core of \matlab in \chapref{chap:CodegenSeq}. \chapref{chap:Arrays}
concentrates on generating efficient code for \matlab arrays and
\chapref{chap:CodegenCon} describes our strategy to generate parallel \xten
